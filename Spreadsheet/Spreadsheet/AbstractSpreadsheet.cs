...
namespace SS
{
    ...
    public abstract class AbstractSpreadsheet
    {
        ...
        /// This method loops through the dependents of a chosen cell and adds the names of them to a linked list.
        /// It keeps track of visited cells and if there is a CircularException.
        /// </summary>
